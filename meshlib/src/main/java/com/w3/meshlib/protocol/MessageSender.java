        ...
        singleThreadExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    socket = new Socket();
                    MeshLog.d("Start sending message");
                    InetAddress addr = InetAddress.getByName(ipAddress);
                    SocketAddress sockaddr = new InetSocketAddress(addr, Constant.MESSAGING_PORT);
                    ...
                    dos.close();
                    socket.close();
                    MeshLog.d("Close sender socket");
                } catch (UnknownHostException e) {
                    e.printStackTrace();
                    MeshLog.d("sender UnknownHostException =" + ipAddress);
                } catch (IOException e) {
                    e.printStackTrace();
                    MeshLog.d("sender IOException =" + ipAddress);
                } finally {
